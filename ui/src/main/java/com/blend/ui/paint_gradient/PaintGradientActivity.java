 ...
 * <p>
 * 自己总结的一点：
 * 给画笔设置着色器，给着色器设置本地矩阵，就能实现一些平移，旋转等效果。
 * 要是使用4种着色器Shader，可以使用着色器的setLocalMatrix来改变着色器，再应用到画笔上，从而改变平移，旋转等效果。
...
public class PaintGradientActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // setContentView(new ZoomImageView(this));  //放大镜，也是使用了两个Bitmap
