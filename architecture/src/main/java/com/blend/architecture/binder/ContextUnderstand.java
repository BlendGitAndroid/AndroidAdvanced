 ...
 * Service，Application，ContextThemeWrapper都继承自这个装饰类。Contextlmpl和ContextWrapper继承自Context,ContextWrapper
 ...
 * LoadedApk的Application，之后在Activity初始化attach方法中将Application赋值给Activity的Application。
 ...
 * 转发操作通过Window.Callback接口实现，Activity实现这个接口，著名的事件分发dispatchTouchEvent就是这个接口的方法。Activity获取WindowManager，
 * 这样在Activity中就能获取WindowManager了。
 * <p>
 * <p>
 * <p>
